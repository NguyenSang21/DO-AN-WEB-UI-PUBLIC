...
class Home extends Component {
  ...
  render() {
	...
	var checkNameLogin = name === null ? "Account" : name;
    return (
        <div>
            <header id="header">
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><Link to={"/"}  activeClassName="active">Products</Link></li>
										<li><Link to={"/product"}  activeClassName="active">Product Details</Link></li> 
										<li><Link to={'/checkout'} activeClassName="active">Checkout</Link></li> 
    ...
    <script async="true" src="../public/js/jquery.js"></script>
	<script  async="true" src="../public/js/bootstrap.min.js"></script>
	<script  async="true" src="../public/js/jquery.scrollUp.min.js"></script>
	<script async="true" src="../public/js/price-range.js"></script>
    <script async="true" src="../public/js/jquery.prettyPhoto.js"></script>
    <script async="true" src="../public/js/main.js"></script>
        </div>
    );
  }
}
