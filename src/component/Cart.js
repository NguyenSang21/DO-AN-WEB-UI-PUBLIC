...
class Cart extends Component {
  ...
  render() {
	...
	var openAccount = name === null ? {display:'none'} : null;
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="search_box pull-right">
							<input type="text" placeholder="Search" value={this.state.keySearch} onChange={this.updateKeySearch.bind(this)} />
							<Link to={`/search/${this.state.keySearch}`}><i class="fa fa-search"></i></Link>
						</div>
					</div>
				</div>
			</div>
